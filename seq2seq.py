...
embed_size = 64
hidden_size = 128
model = Seq2Seq(vocab_size, embed_size, hidden_size)
...
def generate_text(model, start_string, gen_length, char2idx, idx2char):
    ...
    for _ in range(gen_length):
        with torch.no_grad():
            ...
            output, (hidden, cell) = model.encoder(embedded_input, (hidden, cell)) if hidden is None else model.decoder(embedded_input, (hidden, cell))
